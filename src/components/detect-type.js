...
const bmpMagic = [0x42, 0x4D];
const gifMagic = [0x47, 0x49, 0x46];
const exeMagic = [0x4D, 0x5A];
const zipMagic = [0x50, 0x4B, 0x3, 0x4];
const shpMagic = [0x27, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
const icoMagic = [0x00, 0x00, 0x01, 0x00];
...
const check = async (blob, typeMagicArr, offset = 0) => {
    const buffers = await readBuffer(blob, offset, typeMagicArr.length + offset);
    const uint8Array = new Uint8Array(buffers);
    return typeMagicArr.every((header, index) => header === uint8Array[index]);
};
export const readFileTypeFromBlob = async (blob) => {
